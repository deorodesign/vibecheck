      ...
      <div className="max-w-3xl mx-auto space-y-8 mt-4 md:mt-0">
        ...
        <header className="w-full flex items-center justify-between mb-8 md:mb-12">
          <Link href="/" className="flex items-center gap-3 text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors group">
            ...
            <span className="font-black text-[10px] md:text-xs uppercase tracking-widest hidden sm:inline">Back to the Timeline</span>
          </Link>
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-5xl font-black italic uppercase tracking-tighter mb-4">Secure the Bag.</h2>
          <p className="text-zinc-500 font-medium max-w-xl mx-auto text-sm md:text-base">Trade the chaos with virtual USDC, prove you have the best vybe, and farm real money airdrops every 14 days.</p>
        </div>
        ...
        <div className="relative p-8 md:p-10 bg-gradient-to-br from-fuchsia-500/10 to-orange-500/10 border border-fuchsia-500/30 rounded-[2rem] text-center shadow-[0_0_40px_rgba(217,70,239,0.15)] overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm md:text-base font-bold text-zinc-700 dark:text-zinc-300 max-w-md mx-auto leading-relaxed">
              The Top 3 degens on the Leaderboard at the end of the 14-day Season split the bag equally. <br/>
        ...
        <div className="bg-white dark:bg-[#18181b] border border-zinc-200 dark:border-white/5 rounded-[2rem] p-6 md:p-8 shadow-sm">
          <h3 className="text-lg md:text-xl font-black uppercase italic text-zinc-900 dark:text-white mb-6 border-b border-zinc-100 dark:border-white/5 pb-4">How to farm the Airdrop</h3>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-black text-sm md:text-base uppercase tracking-widest mb-1 text-zinc-900 dark:text-white">Farm Season XP</h4>
                <p className="text-xs md:text-sm text-zinc-500 font-medium leading-relaxed">You get +1 XP for every 1 virtual USDC traded. You get a massive +10 XP for every 1 USDC of net profit from winning trades. Read the timeline, print XP.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-black text-sm md:text-base uppercase tracking-widest mb-1 text-zinc-900 dark:text-white">Shill & Earn Daily Bonus</h4>
                <p className="text-xs md:text-sm text-zinc-500 font-medium leading-relaxed">Boost your bag and rank! Hit the <strong className="text-zinc-700 dark:text-zinc-300">Share & Earn</strong> button and <strong className="text-fuchsia-500">actually post/send the link</strong> to your socials (X, Telegram, or WhatsApp) to instantly farm <strong className="text-green-500">+50 USDC</strong> and <strong className="text-fuchsia-500">+50 Season XP</strong>.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-zinc-500 font-medium leading-relaxed">Check the Leaderboard on the main page. The season resets every 14 days. If you hold the 1st, 2nd, or 3rd spot when the simulation resets, you take the bag.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-black text-sm md:text-base uppercase tracking-widest mb-1 text-zinc-900 dark:text-white">Drop your Wallet</h4>
                <p className="text-xs md:text-sm text-zinc-500 font-medium leading-relaxed">Go to your Profile and save your EVM (0x...) or Solana wallet address. This is where we will manually drop the real USDC.</p>
              </div>
            </div>
          </div>
        </div>
