  ...
  return (
    <main className="min-h-screen bg-zinc-50 dark:bg-[#0e0e12] flex flex-col items-center py-12 px-4 transition-colors duration-500 font-sans">
      <div className="w-full max-w-3xl bg-white dark:bg-[#18181b] border border-zinc-200 dark:border-white/5 rounded-[2rem] p-6 md:p-12 shadow-xl">
        <Link href="/" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white text-xs font-bold uppercase tracking-widest mb-8 inline-block transition-colors">← Back to the Chaos</Link>
        
        <h1 className="text-3xl md:text-5xl font-black uppercase italic tracking-tight text-zinc-900 dark:text-white mb-4">
          Vybecheck 101
        </h1>
        <p className="text-zinc-500 dark:text-zinc-400 font-medium mb-10 text-sm md:text-base">The idiot-proof guide to surviving the timeline, trading internet chaos, and securing the bag.</p>
        ...
        <div className="space-y-8 text-zinc-700 dark:text-zinc-300 leading-relaxed">
          ...
          <section className="p-6 md:p-8 bg-zinc-50 dark:bg-black/30 rounded-3xl border border-zinc-200 dark:border-white/5">
            <h2 className="text-xl font-black uppercase tracking-widest text-zinc-900 dark:text-white mb-4">1. The Basics: Read the Timeline</h2>
            <p className="mb-6 font-medium">Every market on Vybecheck is a simple question about upcoming chaos. All you have to do is predict the outcome.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20">
                ...
                <p className="text-sm font-medium text-green-800 dark:text-green-200">You believe the event <strong>WILL</strong> happen. You are riding the vybe and betting "Yes".</p>
              </div>
              <div className="p-5 rounded-2xl bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20">
                ...
                <p className="text-sm font-medium text-red-800 dark:text-red-200">You believe the event <strong>WILL NOT</strong> happen. You are fading the rumor and betting "No".</p>
              </div>
            </div>
          </section>
          ...
          <section className="p-6 md:p-8 bg-white dark:bg-[#18181b] rounded-3xl border border-zinc-200 dark:border-white/5 shadow-sm relative overflow-hidden">
            ...
            <h2 className="text-xl font-black uppercase tracking-widest text-zinc-900 dark:text-white mb-4 relative z-10">2. The Math: Pricing the Chaos</h2>
            ...
            <ul className="list-disc pl-5 space-y-2 mb-4 font-medium text-sm relative z-10 text-zinc-600 dark:text-zinc-400">
              <li><strong>73% means one share costs 73¢ (0.73 USDC).</strong></li>
              <li>The percentage represents what the degenerate "crowd" thinks is the probability of the event happening.</li>
          ...
          <section className="p-6 md:p-8 bg-gradient-to-br from-zinc-100 to-zinc-50 dark:from-zinc-900 dark:to-black rounded-3xl border border-zinc-200 dark:border-white/5">
            <h2 className="text-xl font-black uppercase tracking-widest text-zinc-900 dark:text-white mb-4">3. The Pump: Why prices move</h2>
            <p className="mb-4 font-medium">Just like crypto, prices move constantly based on <strong>supply, demand, and pure FOMO</strong>.</p>
            <div className="p-5 bg-white dark:bg-[#18181b] rounded-2xl border border-zinc-200 dark:border-white/5 text-sm font-medium">
              ...
              Imagine the market asks: <em>"Will X (Twitter) go down for 4 hours?"</em> The price of VYBE is 20¢.<br/><br/>
              Suddenly, Elon tweets about massive server issues. Degens rush to buy VYBE shares. Because of the high demand, the price of VYBE pumps from 20¢ to 80¢. <strong>If you bought early at 20¢, your bag is now worth 4x more!</strong> You can sell right now to lock in profit, or hold to the end.
            </div>
          </section>
          ...
          <section className="p-6 md:p-8 bg-zinc-900 dark:bg-black rounded-3xl border border-zinc-800 dark:border-white/10 text-white shadow-2xl">
            <h2 className="text-xl font-black uppercase tracking-widest text-white mb-4">
              4. The Payoff: Securing the Bag
            </h2>
            <p className="mb-5 text-zinc-300 font-medium">When the deadline hits, the market "resolves" (closes) based on the official receipts and rules.</p>
            ...
            <div className="space-y-3 font-mono text-sm">
              ...
              <div className="p-4 bg-zinc-800 dark:bg-zinc-900 rounded-xl border border-zinc-700">
                If you are <strong className="text-red-400 font-sans uppercase">Wrong</strong>: Your losing shares go to <strong>0.00 USDC</strong>. You got liquidated.
              </div>
            </div>
            
            <p className="mt-5 text-xs text-zinc-400 uppercase tracking-widest font-bold">
              The earlier you read the chaos, the cheaper the shares, and the bigger the profit. Buy the rumor, sell the news.
            </p>
          </section>
